...
\begin{columns}
    \column{0.5\textwidth}
    A programming language is a structured way for humans to communicate instructions to a machine. Computers fundamentally operate on binary logic, which is unintuitive for humans.
...
\begin{frame}{Early Concept of an Algorithm}
  \begin{columns}
    \column{0.6\textwidth}
    Long before modern computers, the concept of an algorithm existed as a precise sequence of steps to solve a problem.
...
\begin{frame}{Assembly Language}
  \begin{columns}
    \column{0.5\textwidth}
    Assembly language was the first step away from raw machine code, replacing binary with mnemonic instructions.
...
\begin{frame}{Fortran}
  \begin{columns}
    ...
    Fortran (FORmula TRANslator) was one of the first high-level programming languages, created for scientific computation. Developed by John Backus at IBM
...
\begin{frame}{LISP}
  \begin{columns}
    \column{0.5\textwidth}
    The LISP family of programming languages is one of the oldest high-level language families, created in the late 1950s.
...
\begin{frame}{Main sources}
  \begin{itemize}
        ...
        \item Praxent. \textit{A History of Programming Languages: From Plankalkül to Swift}. \\
        \href{https://praxent.com/blog/history-of-programming-languages}{\texttt{praxent.com/blog/history-of-programming-languages}}

        \item van Dam, A. (Brown University). \textit{History of Programming Languages Reference}. \\
        ...
        \item IEEE Computer Society. \textit{The Evolution of Programming Languages Timeline}. \\
